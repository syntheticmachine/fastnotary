      ...
      <section className="bg-white py-20 px-4 border-b border-gray-200">
        <Container>
          ...
          <div className="py-8">
            ...
            <a href="#" className="bg-gray-100 py-3 px-4 rounded-md text-gray-600 text-sm font-semibold inline-flex items-center gap-2 hover:text-white hover:bg-gray-900 transition duration-300">
